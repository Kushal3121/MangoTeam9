<%-- Mango - Open Source M2M - http://mango.serotoninsoftware.com Copyright (C)
2006-2011 Serotonin Software Technologies Inc. @author Matthew Lohbihler This
...
with this program. If not, see http://www.gnu.org/licenses/. --%> <%@ include
file="/WEB-INF/jsp/include/tech.jsp" %> <%@page
  ...
  <script type="text/javascript">
    ...
    function saveUser() {
        ...
        if (adminUser) {
            ...
            console.log("Password value before sending:", $get("password"));
      ...
      <td valign="top" id="userList" style="display: none">
        <div class="borderDiv">
          <table width="100%">
            <tr>
              ...
              <td align="right">
                <tag:img
                  png="user_add"
                  onclick="showUser(${applicationScope['constants.Common.NEW_ID']})"
                  title="users.add"
                  id="u${applicationScope['constants.Common.NEW_ID']}Img"
                />
              </td>
            </tr>
          </table>
          <table id="usersTable">
            <tbody
              id="u_TEMPLATE_"
              onclick="showUser(getMangoId(this))"
              class="ptr"
              style="display: none"
            >
              <tr>
        ...
        <div class="borderDiv">
          <table width="100%">
            <tr>
              <td>
                <span class="smallTitle"
                  ><tag:img id="userImg" png="user_green" title="users.user" />
          ...
          <table>
            ...
            <tr>
              <td class="formLabelRequired">
                <fmt:message key="users.newPassword" />
              </td>
              <td class="formField">
            ...
            <tr>
              ...
              <td class="formField">
                <input id="email" type="text" class="formLong" />
              </td>
            </tr>
            <tr>
            ...
            <tr id="administrationRow" style="display: none">
              <td class="formLabelRequired">
                <fmt:message key="common.administrator" />
              </td>
              <td class="formField">
                <input
                  id="administrator"
            ...
            <tr>
              <td class="formLabelRequired">
                <fmt:message key="users.receiveAlarmEmails" />
              </td>
              <td class="formField">
                <select id="receiveAlarmEmails">
            ...
            <tr>
              <td class="formLabelRequired">
                <fmt:message key="users.receiveOwnAuditEvents" />
              </td>
              <td class="formField">
                <input id="receiveOwnAuditEvents" type="checkbox" />
              </td>
            </tr>
            <tbody id="dataSources" style="display: none">
              ...
              <tr id="dataSources">
                <td class="formLabelRequired">
                  <fmt:message key="users.dataSources" />
                </td>
